...
# Understat-specific mapping (display -> raw)
...
TEAM_ABBREVIATIONS <- c(
  ...
  "Udinese" = "UDI", "Sassuolo" = "SAS", "Verona" = "VER", "Lecce" = "LEC",
  "Genoa" = "GEN", "Cagliari" = "CAG", "Empoli" = "EMP", "Monza" = "MON",
  "Venezia" = "VEN", "Parma" = "PAR", "Como" = "COM",
  
  # La Liga
  "Real Madrid" = "RMA", "Barcelona" = "BAR", "Atletico Madrid" = "ATM",
  "Real Sociedad" = "RSO", "Real Betis" = "BET", "Athletic Bilbao" = "ATH",
  "Valencia" = "VAL", "Villarreal" = "VIL", "Sevilla" = "SEV",
  "Celta Vigo" = "CEL", "Getafe" = "GET", "Osasuna" = "OSA",
  "Mallorca" = "MAL", "Rayo Vallecano" = "RAY", "Girona" = "GIR",
  "Alaves" = "ALA", "Las Palmas" = "LPA", "Espanyol" = "ESP",
  ...
  "Union Berlin" = "FCU", "SC Freiburg" = "SCF", "Wolfsburg" = "WOB",
  "Mainz" = "M05", "Borussia Monchengladbach" = "BMG", "Hoffenheim" = "TSG",
  "Werder Bremen" = "SVW", "VfB Stuttgart" = "VFB", "Augsburg" = "FCA",
  "Heidenheim" = "HDH", "Bochum" = "BOC", "Holstein Kiel" = "KIE",
  "FC St Pauli" = "STP",
  
  # Ligue 1
  "Paris Saint-Germain" = "PSG", "Monaco" = "MON", "Marseille" = "OM",
  "Lyon" = "OL", "Lille" = "LIL", "Nice" = "NIC", "Lens" = "LEN",
  "Rennes" = "REN", "Strasbourg" = "STR", "Nantes" = "NAN",
  "Toulouse" = "TOU", "Montpellier" = "MTP", "Brest" = "BRE29",
  "Reims" = "REI", "Le Havre" = "HAV", "Auxerre" = "AUX",
  "Saint-Etienne" = "STE", "Angers" = "ANG"
)
...
simplify_position <- function(position) {
  pos_map <- c(
    "GK" = "GK", "DF" = "DEF", "CB" = "DEF", "LB" = "DEF", "RB" = "DEF",
    "WB" = "MID", "LWB" = "MID", "RWB" = "MID", "MF" = "MID", "DM" = "MID",
    "CM" = "MID", "AM" = "MID", "LM" = "MID", "RM" = "MID",
    "FW" = "FWD", "LW" = "FWD", "RW" = "FWD", "ST" = "FWD", "CF" = "FWD",
    "Sub" = "SUB"
  )
