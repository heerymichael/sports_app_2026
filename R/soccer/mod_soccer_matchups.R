# =============================================================================
# Module: Soccer Match Ups
# 
# This Week's Fixtures with Match Predictions and Team Analysis
# (Renamed from FanTeam Contests)
#
# Layout:
...
soccer_matchups_ui <- function(id) {
  ...
  log_debug("soccer_matchups_ui() called with id:", id, level = "INFO")
  ...
  tagList(
    ...
    tags$head(tags$script(HTML("
      $(document).ready(function() {
        console.log('Match Ups module JS loaded');
    ...
    div(class = "page-header",
        tags$h2("Match Ups"),
        tags$p(class = "text-muted", "This week's fixtures with match predictions and team analysis"),
...
soccer_matchups_server <- function(id, soccer_data = NULL) {
  moduleServer(id, function(input, output, session) {
    ns <- session$ns
    
    log_debug("========================================", level = "INFO")
    log_debug("soccer_matchups_server() initialized", level = "INFO")
    log_debug("========================================", level = "INFO")
